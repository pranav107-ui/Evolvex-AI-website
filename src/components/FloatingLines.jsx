...
vec3 getBackground(vec2 uv) {
  // If lineGradientCount is used, we usually return pure background color
  // But let's respect the backgroundColor uniform
...
vec3 getLineColor(float t, vec3 baseColor) {
  ...
  return gradientColor; // Removed * 0.5 to keep colors vivid
}
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  // Helper to apply wave to color
  // Now we accumulate alpha based on intensity
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // Parse initial background color
